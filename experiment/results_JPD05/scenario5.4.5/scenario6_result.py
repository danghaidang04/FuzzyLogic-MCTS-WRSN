...
if __name__ == '__main__':
    data = pd.read_excel(r'C:\Users\admin\OneDrive\Github\WRSN-team\experiment\results_JPD05\scenario5.4.5\scenario6_result.xlsx')

    fig = plt.figure()
    x = np.array(list(map(float, data['T'])))
